...
static void mtk_clk_enable_critical(void)
{
	...
	clk_prepare_enable(top_data->clks[CLK_TOP_MSDC30_0_SEL]);
	clk_prepare_enable(top_data->clks[CLK_TOP_UART_SEL]);

	clk_prepare_enable(peri_data->clks[CLK_PERI_MSDC30_0]);
...
static const struct mtk_fixed_factor root_clk_alias[] __initconst = {
	...
	FACTOR(CLK_TOP_CLK26M, "clk26m", "clk_null", 1, 1),
	FACTOR(CLK_TOP_AUDIO_EXT1, "audio_ext1_ck", "clk_null", 1, 1),
	FACTOR(CLK_TOP_AUDIO_EXT2, "audio_ext2_ck", "clk_null", 1, 1),
	FACTOR(CLK_TOP_F2W, "f2w_clk", "clk_null", 1, 1),
	FACTOR(CLK_TOP_HDMI_0_PIX340M, "hdmi_0_pix340m", "clk_null", 1, 1),
	FACTOR(CLK_TOP_HDMI_0_DEEP340M, "hdmi_0_deep340m", "clk_null", 1, 1),
	FACTOR(CLK_TOP_HDMI_0_PLL340M, "hdmi_0_pll340m", "clk_null", 1, 1),
	FACTOR(CLK_TOP_HDMITX_CLKDIG_CTS, "hdmitx_dig_cts", "clk_null", 1, 1),
	FACTOR(CLK_TOP_HDMI_0_MON, "hdmi_0_mon_ck", "clk_null", 1, 1),
	FACTOR(CLK_TOP_HDMI_SCL_RX, "hdmi_scl_rx", "clk_null", 1, 1),
	FACTOR(CLK_TOP_HADDS2_FB, "hadds2_fbclk", "clk_null", 1, 1),
	FACTOR(CLK_TOP_DSIO_LNTC_DSI, "dsio_lntc_dsick", "clk_null", 1, 1),
	FACTOR(CLK_TOP_WBG_DIG_416M, "wbg_dig_ck_416m", "clk_null", 1, 1),
	FACTOR(CLK_TOP_32K_EXTERNAL, "32k_external", "clk_null", 1, 1),
};
...
static const struct mtk_fixed_factor top_divs[] __initconst = {
	...
	FACTOR(CLK_TOP_SYSPLL1_D2, "syspll1_d2", "syspll_ck", 1, 2),
	FACTOR(CLK_TOP_SYSPLL1_D4, "syspll1_d4", "syspll_ck", 1, 4),
	FACTOR(CLK_TOP_SYSPLL1_D8, "syspll1_d8", "syspll_ck", 1, 8),
	FACTOR(CLK_TOP_SYSPLL1_D16, "syspll1_d16", "syspll_ck", 1, 16),
	FACTOR(CLK_TOP_SYSPLL2_D2, "syspll2_d2", "syspll_d2", 1, 2),
	FACTOR(CLK_TOP_SYSPLL2_D4, "syspll2_d4", "syspll_d2", 1, 4),
	FACTOR(CLK_TOP_SYSPLL2_D8, "syspll2_d8", "syspll_d2", 1, 8),
	...
	FACTOR(CLK_TOP_RTC32K_I, "rtc32k_CK_I", "rtc32k", 1, 1),
...
static const struct mtk_composite top_muxes[] __initconst = {
	...
	MUX_GATE(CLK_TOP_NR_SEL, "nr_sel", nr_osd_parents,
							0x00B0, 16, 3, 23),
	MUX_GATE(CLK_TOP_OSD_SEL, "osd_sel", nr_osd_parents, 0x015c, 24, 3, 31),
	/* CLK_CFG_12 */
	...
	MUX_GATE(CLK_TOP_CMSYS_SEL, "cmsys_sel",
		    cmsys_parents, 0x00E0, 16, 4, 23),
	MUX_GATE(CLK_TOP_SPI1_SEL, "spi1_sel", spi_parents, 0x00E0, 24, 3, 31),
	/* CLK_CFG_15 */
	MUX_GATE(CLK_TOP_SPI2_SEL, "spi2_sel", spi_parents, 0x00F0, 0, 3, 7),
...
static const struct mtk_gate peri_clks[] __initconst = {
	...
	GATE_PERI0(CLK_PERI_UART3, "uart3_ck", "uart_sel", 22),
	GATE_PERI0(CLK_PERI_UART2, "uart2_ck", "uart_sel", 21),
	GATE_PERI0(CLK_PERI_UART1, "uart1_ck", "uart_sel", 20),
	GATE_PERI0(CLK_PERI_UART0, "uart0_ck", "uart_sel", 19),
...
static void __init mtk_pericfg_init(struct device_node *node)
{
	...
	peri_data = clk_data = mtk_alloc_clk_data(CLK_PERI_NR);
...
static const struct mtk_gate aud_clks[] __initconst = {
	...
	GATE_AUD4(CLK_AUD_HDMIRX, "aud_hdmirx", "audio_sel", 18),
	GATE_AUD4(CLK_AUD_INTDIR, "aud_intdir", "audio_sel", 19),
...
static const struct mtk_gate mm_clks[] __initconst = {
	...
	GATE_DISP1(CLK_MM_HDMI_PIXEL, "mm_hdmi_pixel", "", 8),
...
CLK_OF_DECLARE(mtk_mmsys, "mediatek,mt2701-mmsyscfg", mtk_mmsys_init);
...
CLK_OF_DECLARE(mtk_imgsys, "mediatek,mt2701-imgsyscfg", mtk_imgsys_init);
...
static void __init mtk_apmixedsys_init(struct device_node *node)
{
	...
	pll_data = clk_data = mtk_alloc_clk_data(ARRAY_SIZE(apmixed_plls));
	if (!clk_data)
		return;
