...
#define MA_EINT_NAME            "mediatek,fingerprint-eint"
...
#define FINGERPRINT_TAP 				KEY_F11//	831
...
#define MALOGF(x) printk(KERN_ERR "%s%s: debug log! %s!\n", MALOG_TAG, __func__, x);										//flag log
#define MALOGD(x) MALOGF(x)																									//debug log
#define MALOGW(x) printk(KERN_ERR "%s%s: warning log! the function %s's ret = %d\n", MALOG_TAG, __func__,x, ret);			//warning log
//use for the log print
