 ...
 */
	...
	mas_finger_power1v8_on = pinctrl_lookup_state(mas_finger_pinctrl, "finger_reset_en1");
	...
	mas_finger_power1v8_off = pinctrl_lookup_state(mas_finger_pinctrl, "finger_reset_en0");
