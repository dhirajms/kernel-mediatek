...
#define REG_MMUG_CTRL			0x5d8
#define F_MMUG_CTRL_INV_EN0		(1<<0)
/* this will be no use for 2701 */
#define F_MMUG_CTRL_INV_EN1		(1<<0)
/* l2 invalid */
#define F_MMUG_CTRL_INV_EN2		(1<<1)
#define F_MMUG_CTRL_PRE_LOCK(en)	(!!(en) << 3)
#define F_MMUG_CTRL_PRE_EN		(1<<4)


#define REG_L2_GDC_STATE		0x0
#define REG_MMUG_INVLD			0x5C0
#define F_MMUG_INV_ALL			0x2
#define F_MMUG_INV_RANGE		0x1

#define REG_MMUG_INVLD_SA		(REG_MMUG_INVLD + 0x4)
#define REG_MMUG_INVLD_EA		(REG_MMUG_INVLD + 0x8)

#define REG_MMUG_PT_BASE		0x0
#define REG_MMUG_PT_BASE_SEC		0x4


#define REG_MMUG_DCM			0x5F0
#define F_MMUG_DCM_ON			1

/*M4U_L2_BASE*/
#define REG_L2_OFFSET			0x600
#define REG_L2_GDC_STAT			0x0
...
#define F_MMU_VA_MSK				(~0xFFF)
#define F_MMU_FAULT_VA_MSK			F_MMU_VA_MSK
