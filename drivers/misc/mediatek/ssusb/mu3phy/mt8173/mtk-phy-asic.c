...
static int phy_port1_init(struct u3phy_info *info)
{
	...
	/*Wait 800 usec */
	udelay(800);
	u3phy_writel(sif_base, U3D_U2PHYDCR1, E60802_RG_USB20_SW_PLLMODE_OFST,
		     E60802_RG_USB20_SW_PLLMODE, 1);
...
static void usb_port1_phy_restore(struct u3phy_info *info, unsigned int clk_on)
{
	...
	u3phy_writel(sif_base, U3D_USBPHYACR4, E60802_RG_USB20_FS_SR_OFST, E60802_RG_USB20_FS_SR,
		     2);
	u3phy_writel(sif_base, U3D_USBPHYACR4, E60802_RG_USB20_FS_CR_OFST, E60802_RG_USB20_FS_CR,
		     2);
}
