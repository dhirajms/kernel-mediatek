...
#define VSYNC_DBG(fmt, arg...) pr_debug(MTKFB_VSYNC_DEVNAME"/"fmt, ##arg)
#define VSYNC_INF(fmt, arg...) pr_info(MTKFB_VSYNC_DEVNAME"/"fmt, ##arg)
#define VSYNC_WRN(fmt, arg...) pr_warn(MTKFB_VSYNC_DEVNAME"/"fmt, ##arg)
#define VSYNC_ERR(fmt, arg...) pr_err(MTKFB_VSYNC_DEVNAME"/"fmt, ##arg)
