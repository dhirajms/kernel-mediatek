...
*/
	...
	typedef struct {
		...
		uint32_t RESET;	/* C010 */
		uint32_t rsv_0014[2];	/* C014..C018 */
		LCD_REG_SIF_TIMING SIF_TIMING[2];	/* C01C..C020 */
		uint32_t rsv_0024;	/* C024 */
		...
		uint32_t SRC_ADD;	/* C074 */
		uint32_t SRC_PITCH;	/* C078 */
		uint32_t rsv_007C[5];	/* C07C..C08C */
/* LCD_REG_DITHER_CON                DITHER_CON;         // C080 */
/* uint32_t                            rsv_0084[3];        // C084..C08C */
		LCD_REG_ULTRA_CON ULTRA_CON;	/* C090 */
		uint32_t CONSUME_RATE;	/* C094 */
		LCD_REG_DBI_ULTRA_TH DBI_ULTRA_TH;	/* C098 */
		LCD_REG_GMC_ULTRA_TH GMC_ULTRA_TH;	/* 109C */
		uint32_t rsv_00A0[728];	/* C0A0..CBFC */
		uint32_t CMDQ[32];	/* CC00..CC7F */
		uint32_t rsv_1D00[160];	/* CC80..CEFC */
		uint32_t PCMD0;	/* CF00 */
		uint32_t rsv_1F04[7];	/* CF04..CF1C */
		uint32_t PCMD1;	/* CF20 */
		uint32_t rsv_1F24[7];	/* CF24..1C3C */
		uint32_t PCMD2;	/* CF40 */
		uint32_t rsv_1F44[15];	/* CF44..CF7C */
		uint32_t SCMD0;	/* CF80 */
		uint32_t rsv_1F84[7];	/* CF84..CF9C */
		uint32_t SCMD1;	/* CFA0 */
		uint32_t rsv_1FA4[7];	/* CFA4..CFBC */
