...
#define DDP_REG_BASE_DISP_RDMA0	   0xf4008000
#define DDP_REG_BASE_DISP_RDMA1	   0xf4012000
...
#define DDP_REG_BASE_DPI0	       0xf400D000
#define DDP_REG_BASE_DPI1	       0xf4014000
...
#define DDP_REG_BASE_UFOE	       0xf4013000
#define DDP_REG_BASE_HDMI	       0xf4015000
#define DDP_REG_BASE_LVDS	       0xf4016000
#define DDP_REG_BASE_DBI	       0xf500E000
#else
#define DDP_REG_BASE_MMSYS_CONFIG  (disp_dev.regs_va[DISP_REG_CONFIG])
#define DDP_REG_BASE_DISP_OVL	   (disp_dev.regs_va[DISP_REG_OVL])
#define DDP_REG_BASE_DISP_RDMA0	   (disp_dev.regs_va[DISP_REG_RDMA0])
#define DDP_REG_BASE_DISP_RDMA1	   (disp_dev.regs_va[DISP_REG_RDMA1])
#define DDP_REG_BASE_DISP_WDMA	   (disp_dev.regs_va[DISP_REG_WDMA])
#define DDP_REG_BASE_DISP_BLS	   (disp_dev.regs_va[DISP_REG_BLS])
#define DDP_REG_BASE_DISP_COLOR	   (disp_dev.regs_va[DISP_REG_COLOR])
...
#define DDP_REG_BASE_UFOE	       (disp_dev.regs_va[DISP_REG_UFOE])
#define DDP_REG_BASE_HDMI	       (disp_dev.regs_va[DISP_REG_HDMI])
#define DDP_REG_BASE_LVDS	       (disp_dev.regs_va[DISP_REG_LVDS])
#define DDP_REG_BASE_TVE	       (disp_dev.regs_va[DISP_REG_TVE])
...
#define DISPSYS_WDMA_BASE       DDP_REG_BASE_DISP_WDMA
...
#define DISPSYS_REG_ADDR_MAX    (DDP_REG_BASE_TVE+0x2000)
/* --------------------------------------------------------------------------- */
...
#define REG_FLD_SET(field, reg32, val) \
	((reg32) = (((reg32) & ~REG_FLD_MASK(field))|REG_FLD_VAL((field), (val))))
...
/* ----------------------------------------------------------------- */
/* RDMA */
#define DISP_REG_RDMA_INT_ENABLE              (DISPSYS_RDMA0_BASE + 0x00)
#define DISP_REG_RDMA_INT_STATUS              (DISPSYS_RDMA0_BASE + 0x04)
#define DISP_REG_RDMA_GLOBAL_CON              (DISPSYS_RDMA0_BASE + 0x10)
#define DISP_REG_RDMA_SIZE_CON_0              (DISPSYS_RDMA0_BASE + 0x14)
#define DISP_REG_RDMA_SIZE_CON_1              (DISPSYS_RDMA0_BASE + 0x18)
#define DISP_REG_RDMA_TARGET_LINE             (DISPSYS_RDMA0_BASE + 0x1C)
#define DISP_REG_RDMA_MEM_CON                 (DISPSYS_RDMA0_BASE + 0x24)
#define DISP_REG_RDMA_MEM_START_ADDR          (DISPSYS_RDMA0_BASE + 0x28)
#define DISP_REG_RDMA_MEM_SRC_PITCH           (DISPSYS_RDMA0_BASE + 0x2C)
#define DISP_REG_RDMA_MEM_GMC_SETTING_0       (DISPSYS_RDMA0_BASE + 0x30)
#define DISP_REG_RDMA_MEM_SLOW_CON            (DISPSYS_RDMA0_BASE + 0x34)
#define DISP_REG_RDMA_MEM_GMC_SETTING_1       (DISPSYS_RDMA0_BASE + 0x38)
#define DISP_REG_RDMA_FIFO_CON                (DISPSYS_RDMA0_BASE + 0x40)
#define DISP_REG_RDMA_FIFO_LOG                (DISPSYS_RDMA0_BASE + 0x44)
#define DISP_REG_RDMA_CF_00                   (DISPSYS_RDMA0_BASE + 0x54)
#define DISP_REG_RDMA_CF_01                   (DISPSYS_RDMA0_BASE + 0x58)
#define DISP_REG_RDMA_CF_02                   (DISPSYS_RDMA0_BASE + 0x5C)
#define DISP_REG_RDMA_CF_10                   (DISPSYS_RDMA0_BASE + 0x60)
#define DISP_REG_RDMA_CF_11                   (DISPSYS_RDMA0_BASE + 0x64)
#define DISP_REG_RDMA_CF_12                   (DISPSYS_RDMA0_BASE + 0x68)
#define DISP_REG_RDMA_CF_20                   (DISPSYS_RDMA0_BASE + 0x6C)
#define DISP_REG_RDMA_CF_21                   (DISPSYS_RDMA0_BASE + 0x70)
#define DISP_REG_RDMA_CF_22                   (DISPSYS_RDMA0_BASE + 0x74)
#define DISP_REG_RDMA_CF_PRE_ADD0             (DISPSYS_RDMA0_BASE + 0x78)
#define DISP_REG_RDMA_CF_PRE_ADD1             (DISPSYS_RDMA0_BASE + 0x7C)
#define DISP_REG_RDMA_CF_PRE_ADD2             (DISPSYS_RDMA0_BASE + 0x80)
#define DISP_REG_RDMA_CF_POST_ADD0            (DISPSYS_RDMA0_BASE + 0x84)
#define DISP_REG_RDMA_CF_POST_ADD1            (DISPSYS_RDMA0_BASE + 0x88)
#define DISP_REG_RDMA_CF_POST_ADD2            (DISPSYS_RDMA0_BASE + 0x8C)
#define DISP_REG_RDMA_DUMMY                   (DISPSYS_RDMA0_BASE + 0x90)
#define DISP_REG_RDMA_DEBUG_OUT_SEL           (DISPSYS_RDMA0_BASE + 0x94)



/* ----------------------------------------------------------------- */
/* WDMA */
#define DISP_REG_WDMA_INTEN               (DISPSYS_WDMA_BASE+0x00)
#define DISP_REG_WDMA_INTSTA              (DISPSYS_WDMA_BASE+0x04)
#define DISP_REG_WDMA_EN                  (DISPSYS_WDMA_BASE+0x08)
#define DISP_REG_WDMA_RST                 (DISPSYS_WDMA_BASE+0x0C)
#define DISP_REG_WDMA_SMI_CON             (DISPSYS_WDMA_BASE+0x10)
#define DISP_REG_WDMA_CFG                 (DISPSYS_WDMA_BASE+0x14)
#define DISP_REG_WDMA_SRC_SIZE            (DISPSYS_WDMA_BASE+0x18)
#define DISP_REG_WDMA_CLIP_SIZE           (DISPSYS_WDMA_BASE+0x1C)
#define DISP_REG_WDMA_CLIP_COORD          (DISPSYS_WDMA_BASE+0x20)
#define DISP_REG_WDMA_DST_ADDR            (DISPSYS_WDMA_BASE+0x24)
#define DISP_REG_WDMA_DST_W_IN_BYTE       (DISPSYS_WDMA_BASE+0x28)
#define DISP_REG_WDMA_ALPHA               (DISPSYS_WDMA_BASE+0x2C)
#define DISP_REG_WDMA_BUF_ADDR            (DISPSYS_WDMA_BASE+0x30)
#define DISP_REG_WDMA_STA                 (DISPSYS_WDMA_BASE+0x34)
#define DISP_REG_WDMA_BUF_CON1            (DISPSYS_WDMA_BASE+0x38)
#define DISP_REG_WDMA_BUF_CON2            (DISPSYS_WDMA_BASE+0x3C)
#define DISP_REG_WDMA_C00                 (DISPSYS_WDMA_BASE+0x40)
#define DISP_REG_WDMA_C02                 (DISPSYS_WDMA_BASE+0x44)
#define DISP_REG_WDMA_C10                 (DISPSYS_WDMA_BASE+0x48)
#define DISP_REG_WDMA_C12                 (DISPSYS_WDMA_BASE+0x4C)
#define DISP_REG_WDMA_C20                 (DISPSYS_WDMA_BASE+0x50)
#define DISP_REG_WDMA_C22                 (DISPSYS_WDMA_BASE+0x54)
#define DISP_REG_WDMA_PRE_ADD0            (DISPSYS_WDMA_BASE+0x58)
#define DISP_REG_WDMA_PRE_ADD2            (DISPSYS_WDMA_BASE+0x5C)
#define DISP_REG_WDMA_POST_ADD0           (DISPSYS_WDMA_BASE+0x60)
#define DISP_REG_WDMA_POST_ADD2           (DISPSYS_WDMA_BASE+0x64)
#define DISP_REG_WDMA_DST_U_ADDR          (DISPSYS_WDMA_BASE+0x70)
#define DISP_REG_WDMA_DST_V_ADDR          (DISPSYS_WDMA_BASE+0x74)
#define DISP_REG_WDMA_DST_UV_PITCH        (DISPSYS_WDMA_BASE+0x78)
#define DISP_REG_WDMA_DITHER_CON          (DISPSYS_WDMA_BASE+0x90)
#define DISP_REG_WDMA_FLOW_CTRL_DBG       (DISPSYS_WDMA_BASE+0xA0)
#define DISP_REG_WDMA_EXEC_DBG            (DISPSYS_WDMA_BASE+0xA4)
#define DISP_REG_WDMA_CLIP_DBG            (DISPSYS_WDMA_BASE+0xA8)
