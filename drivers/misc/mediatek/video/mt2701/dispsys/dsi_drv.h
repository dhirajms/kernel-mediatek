...
#define DSI_STATUS    enum DSI_STATUS
...
#define DSI_INS_TYPE    enum DSI_INS_TYPE
...
#define DSI_CMDQ_BTA    enum DSI_CMDQ_BTA
...
#define DSI_CMDQ_HS    enum DSI_CMDQ_HS
...
#define DSI_CMDQ_CL    enum DSI_CMDQ_CL
...
#define DSI_CMDQ_TE    enum DSI_CMDQ_TE
...
#define DSI_CMDQ_RPT    enum DSI_CMDQ_RPT
...
#define DSI_PLL_CONFIG    struct DSI_PLL_CONFIG
	...
	DSI_STATUS DSI_TXRX_Control(bool cksm_en,
				    ...
				    bool dis_eotp_en,
				    bool hstx_cklp_en, unsigned int max_return_size);
	...
	void DSI_set_cmdq_V3(LCM_setting_table_V3 *para_tbl, unsigned int size,
	...
	uint32_t DSI_dcs_read_lcm_reg(unsigned char);
