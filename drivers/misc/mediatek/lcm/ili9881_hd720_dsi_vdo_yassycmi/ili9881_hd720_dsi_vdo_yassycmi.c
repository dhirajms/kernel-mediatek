...
static struct LCM_setting_table lcm_initialization_setting1[] = {
	...
	*/
		...
		{0x53,1,{0x95}},               //VCOM1  //0x8C //modify@zte.com.cn 20160603
		{0x55,1,{0x99}},               //VCOM2
		...
		//modify@zte.com.cn 20160603 begin
		{0xA1,1,{0x1E}},               //VP251
		{0xA2,1,{0x2E}},               //VP247
		{0xA3,1,{0x12}},               //VP243
		{0xA4,1,{0x16}},               //VP239
		...
		{0x29, 0,{0x00}},
		{REGFLAG_END_OF_TABLE, 0x00, {}}
		//modify@zte.com.cn 20160603 end
};
#if 0
...
//modify@zte.com.cn 20160921 beign for mipi distraction
//modify@zte.com.cn 20160927 backspacing mipi clock modify begin
// To fix rf
		params->dsi.PLL_CLOCK = 212;	   // 245;
//modify@zte.com.cn 20160927 backspacing mipi clock modify end
	//	params->dsi.ss

//		params->dsi.CLK_TRAIL = 17;
			
//modify@zte.com.cn 20160921 end
...
extern unsigned char which_lcd_module_triple_cust(void); //modify@zte.com.cn 20160605
static unsigned int lcm_compare_id(void)
{
	...
	//modify@zte.com.cn add at20160605 end
#ifdef GPIO_LCD_BIAS_ENP_PIN
	mt_set_gpio_mode(GPIO_LCD_BIAS_ENP_PIN, GPIO_MODE_00);
	mt_set_gpio_dir(GPIO_LCD_BIAS_ENP_PIN, GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO_LCD_BIAS_ENP_PIN, GPIO_OUT_ONE);
...
LCM_DRIVER ili9881_hd720_dsi_vdo_yassycmi_lcm_drv =
{
    .name           	= "ili9881_hd720_dsi_vdo_yassycmi",
