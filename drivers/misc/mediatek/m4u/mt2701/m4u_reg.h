#ifndef _MT2701_M4U_REG_H__
#define _MT2701_M4U_REG_H__


extern struct m4u_device *gM4uDev;

#define M4U_BASE0	((unsigned long)gM4uDev->m4u_base[0])
#define M4U_BASE1	((unsigned long)gM4uDev->m4u_base[0])
#define M4U_BASEg	((unsigned long)gM4uDev->m4u_base[0])


#define SMI_COMMON_EXT_BASE 0xF4011000


/* SMI ALWAYS ON 0xF000C000*/
#define SMI_COMMON_AO_BASE	((unsigned long)gM4uDev->smi_common_ao)

#define M4U_L2_BASE	((unsigned long)gM4uDev->L2_base)
...
#define REG_MMUg_PT_BASE           (0x0 + M4U_BASEg)
#define F_MMUg_PT_VA_MSK        0xffff0000
#define REG_MMUg_PT_BASE_SEC         (0x4+M4U_BASEg)
...
#define F_READ_ENTRY_TLB_SEL_PFH        F_BIT_SET(12)
...
#define F_INT_ID_TF_LARB_ID(regval)     F_MSK_SHIFT(regval, 15, 13)
...
#define REG_MMUg_INVLD		(0x5c0  + M4U_BASEg)
#define F_MMUg_INV_ALL		0x2
#define F_MMUg_INV_RANGE		0x1

#define REG_MMUg_INVLD_SA	(0x5c4  + M4U_BASEg)
#define REG_MMUg_INVLD_EA	(0x5c8  + M4U_BASEg)


#define REG_MMUg_INVLD_SEC	(0x5cc + M4U_BASEg)
#define F_MMUg_INV_SEC_ALL	0x2
#define F_MMUg_INV_SEC_RANGE	0x1

#define REG_MMUg_INVLD_SA_SEC	(0x5d0 + M4U_BASEg)
#define REG_MMUg_INVLD_EA_SEC	(0x5d4 + M4U_BASEg)

#define REG_MMUg_CTRL		(0x5d8 + M4U_BASEg)
#define F_MMUg_CTRL_INV_EN0	(1 << 0)
#define F_MMUg_CTRL_INV_EN1	(1 << 0)
#define F_MMUg_CTRL_INV_EN2	(1 << 1)
#define F_MMUg_CTRL_PRE_LOCK(en)	F_BIT_VAL(en, 3)
#define F_MMUg_CTRL_PRE_EN	(1 << 4)


#define REG_MMUg_CTRL_SEC	(0x5dc + M4U_BASEg)
...
#define REG_MMUg_SEC_ABORT_INFO	(0x5e0 + M4U_BASEg)
...
#define F_L2_GDC_BYPASS(en)	F_BIT_VAL(en, 5)
#define F_GET_L2_GDC_PERF_MASK(regval)	F_MSK_SHIFT(regval, 4, 2)
#define F_L2_GDC_PERF_MASK(msk)	F_VAL(msk, 4, 2)
#define GDC_PERF_MASK_HIT_MISS	0
#define GDC_PERF_MASK_RI_RO	1
#define GDC_PERF_MASK_READ_OUTSTAND_FIFO	2
#define F_L2_GDC_PERF_EN(en)	F_BIT_VAL(en, 1)
#define F_L2_GDC_PAUSE_OP(op)	F_VAL(op, 0, 0)
#define GDC_NO_PAUSE	0
#define GDC_READ_PAUSE	1


#define REG_L2_GDC_PERF0	(0x8  + M4U_L2_BASE)
#define REG_L2_GPE_STATUS	(0xc + M4U_L2_BASE)
#define F_L2_GPE_ST_RANGE_INV_DONE	2
#define F_L2_GPE_ST_PREFETCH_DONE		1

#define REG_L2_GPE_STATUS_SEC	(0x10 + M4U_L2_BASE)
...
/* the pagetable PT transferred by m4u to L2 is:
[31]	secure bit
[30:13	TAG
[12:6]	SetIndex
[5:4]	CacheLineIndex
