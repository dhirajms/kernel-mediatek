/******************************************************************************
 * mt8173_isp.c	- MT8173 Linux ISP Device Driver
 *
...
#define LOG_WRN(format, args...)    pr_warn(MyTag "[%s, line%05d]Warning:" format, __func__, __LINE__, ##args)
#define LOG_ERR(format, args...)    pr_err(MyTag "[%s, line%05d]ERROR:" format, __func__, __LINE__, ##args)
#define LOG_AST(format, args...)    pr_alert(MyTag "[%s, line%05d]ASSERT:" format, __func__, __LINE__, ##args)
