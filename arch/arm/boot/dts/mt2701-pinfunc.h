...
#define MT2701_PIN_22_EINT0__FUNC_PCIE0_PERST_N (MTK_PIN_NO(22) | 2)
...
#define MT2701_PIN_23_EINT1__FUNC_PCIE1_PERST_N (MTK_PIN_NO(23) | 2)
...
#define MT2701_PIN_24_EINT2__FUNC_PCIE2_PERST_N (MTK_PIN_NO(24) | 2)
...
#define MT2701_PIN_29_EINT7__FUNC_PCIE2_PERST_N (MTK_PIN_NO(29) | 6)
...
#define MT2701_PIN_38_I2S2_DATA__FUNC_I2S2_DATA (MTK_PIN_NO(38) | 1)
...
#define MT2701_PIN_189_I2S3_DATA__FUNC_I2S3_DATA (MTK_PIN_NO(189) | 1)
...
#define MT2701_PIN_208_AUD_EXT_CK1__FUNC_PCIE0_PERST_N (MTK_PIN_NO(208) | 3)
...
#define MT2701_PIN_209_AUD_EXT_CK2__FUNC_PCIE1_PERST_N (MTK_PIN_NO(209) | 3)
...
#define MT2701_PIN_249_MSDC0E_RSTB__FUNC_GPIO249 (MTK_PIN_NO(249) | 0)
#define MT2701_PIN_249_MSDC0E_RSTB__FUNC_MSDC0E_RSTB (MTK_PIN_NO(249) | 1)

#define MT2701_PIN_250_MSDC0E_DAT7__FUNC_GPIO250 (MTK_PIN_NO(250) | 0)
#define MT2701_PIN_250_MSDC0E_DAT7__FUNC_MSDC3_DAT7 (MTK_PIN_NO(250) | 1)
#define MT2701_PIN_250_MSDC0E_DAT7__FUNC_PCIE0_CLKREQ_N (MTK_PIN_NO(250) | 6)

#define MT2701_PIN_251_MSDC0E_DAT6__FUNC_GPIO251 (MTK_PIN_NO(251) | 0)
#define MT2701_PIN_251_MSDC0E_DAT6__FUNC_MSDC3_DAT6 (MTK_PIN_NO(251) | 1)
#define MT2701_PIN_251_MSDC0E_DAT6__FUNC_PCIE0_WAKE_N (MTK_PIN_NO(251) | 6)

#define MT2701_PIN_252_MSDC0E_DAT5__FUNC_GPIO252 (MTK_PIN_NO(252) | 0)
#define MT2701_PIN_252_MSDC0E_DAT5__FUNC_MSDC3_DAT5 (MTK_PIN_NO(252) | 1)
#define MT2701_PIN_252_MSDC0E_DAT5__FUNC_PCIE1_CLKREQ_N (MTK_PIN_NO(252) | 6)

#define MT2701_PIN_253_MSDC0E_DAT4__FUNC_GPIO253 (MTK_PIN_NO(253) | 0)
#define MT2701_PIN_253_MSDC0E_DAT4__FUNC_MSDC3_DAT4 (MTK_PIN_NO(253) | 1)
#define MT2701_PIN_253_MSDC0E_DAT4__FUNC_PCIE1_WAKE_N (MTK_PIN_NO(253) | 6)

#define MT2701_PIN_254_MSDC0E_DAT3__FUNC_GPIO254 (MTK_PIN_NO(254) | 0)
#define MT2701_PIN_254_MSDC0E_DAT3__FUNC_MSDC3_DAT3 (MTK_PIN_NO(254) | 1)
#define MT2701_PIN_254_MSDC0E_DAT3__FUNC_PCIE2_CLKREQ_N (MTK_PIN_NO(254) | 6)

#define MT2701_PIN_255_MSDC0E_DAT2__FUNC_GPIO255 (MTK_PIN_NO(255) | 0)
#define MT2701_PIN_255_MSDC0E_DAT2__FUNC_MSDC3_DAT2 (MTK_PIN_NO(255) | 1)
#define MT2701_PIN_255_MSDC0E_DAT2__FUNC_PCIE2_WAKE_N (MTK_PIN_NO(255) | 6)

#define MT2701_PIN_256_MSDC0E_DAT1__FUNC_GPIO256 (MTK_PIN_NO(256) | 0)
#define MT2701_PIN_256_MSDC0E_DAT1__FUNC_MSDC3_DAT1 (MTK_PIN_NO(256) | 1)

#define MT2701_PIN_257_MSDC0E_DAT0__FUNC_GPIO257 (MTK_PIN_NO(257) | 0)
#define MT2701_PIN_257_MSDC0E_DAT0__FUNC_MSDC3_DAT0 (MTK_PIN_NO(257) | 1)

#define MT2701_PIN_258_MSDC0E_CMD__FUNC_GPIO258 (MTK_PIN_NO(258) | 0)
#define MT2701_PIN_258_MSDC0E_CMD__FUNC_MSDC3_CMD (MTK_PIN_NO(258) | 1)

#define MT2701_PIN_259_MSDC0E_CLK__FUNC_GPIO259 (MTK_PIN_NO(259) | 0)
#define MT2701_PIN_259_MSDC0E_CLK__FUNC_MSDC3_CLK (MTK_PIN_NO(259) | 1)

#define MT2701_PIN_260_MSDC0E_DSL__FUNC_GPIO260 (MTK_PIN_NO(260) | 0)
#define MT2701_PIN_260_MSDC0E_DSL__FUNC_MSDC3_DSL (MTK_PIN_NO(260) | 1)
