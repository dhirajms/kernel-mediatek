...
#ifndef _MT2701_AFE_REG_H_
#define _MT2701_AFE_REG_H_


/* export to mt2701-afe.c only */
...
#define CLK_AUD_INTBUS_SEL_SYSPLL1D4 (0x1 << 24)
...
#define DSD_ENC_CON0          (AFE_BASE + 0x11C0)
#define DSD_ENC_CON1          (AFE_BASE + 0x11C4)
#define DSD_ENC_CON2          (AFE_BASE + 0x11C8)
...
#define IEC_BURST_READY_MASK     (1 << 16)
#define IEC_BURST_READY_NOT_READY (1 << 16)
...
#define IEC2_BURST_READY_MASK     (1 << 16)
#define IEC2_BURST_READY_NOT_READY (1 << 16)
/* AFE_IEC2_BURST_LEN */
