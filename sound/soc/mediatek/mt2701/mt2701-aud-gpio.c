...
static struct audio_gpio_attr aud_gpios[GPIO_NUM] = {
	...
	[GPIO_I2S0_LRCK_MODE0_GPIO] = {"audi2s0lrck-mode0-gpio", false, NULL},
	[GPIO_I2S0_LRCK_MODE1_I2S0] = {"audi2s0lrck-mode1-i2s0", false, NULL},
	...
	[GPIO_SPDIF_IN0_MODE1_SPDIF] = {"audspdifin0-mode0-spdif", false, NULL},
	[GPIO_SPDIF_IN1_MODE0_GPIO] = {"audspdifin1-mode0-gpio", false, NULL},
	[GPIO_SPDIF_IN1_MODE1_SPDIF] = {"audspdifin1-mode0-spdif", false, NULL},
};

int aud_i2s0_lrck_gpio = -1;

void mt2701_GPIO_probe(void *dev)
{
	int ret;
	int i = 0;
...
int mt2701_GPIO_I2S0_LRCK_Select(enum I2S0_LRCK_PIN_SEL pin_select)
{
	int retval = 0;
...
int mt2701_GPIO_I2S2_Select(enum I2S2_PIN_SEL pin_select)
{
	int retval = 0;
...
int mt2701_GPIO_PCM_Select(enum PCM_PIN_SEL pin_select)
{
	int retval = 0;
...
int mt2701_GPIO_SPDIF_IN0_Select(enum SPDIF_PIN_SEL pin_select)
{
	int retval = 0;
...
int mt2701_GPIO_SPDIF_IN1_Select(enum SPDIF_PIN_SEL pin_select)
{
	int retval = 0;
