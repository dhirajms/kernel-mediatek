...
#ifndef _MT2701_AFE_H_
#define _MT2701_AFE_H_
...
enum afe_dsd_width {
	DSD_WIDTH_32BIT = 0,	/* L(32bit) R(32bit) ... */
	DSD_WIDTH_16BIT = 1,	/* L(16bit) R(16bit) ... */
	DSD_WIDTH_8BIT = 2	/* common scenario */
};
...
{
	return (FMT_64CYCLE_32BIT_I2S <= format && format <= FMT_64CYCLE_24BIT_RJ) ? 1 : 0;
}
...
extern enum afe_dsdenc_mode dsdenc_mode;
